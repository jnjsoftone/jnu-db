"use strict";var e;Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"MySqlSchemaManager",{enumerable:!0,get:function(){return t}});const n=(e=require("mysql2/promise"))&&e.__esModule?e:{default:e};function a(e,n,a){return n in e?Object.defineProperty(e,n,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[n]=a,e}class t{async init(){this.connection=await n.default.createConnection({host:this.config.host,port:this.config.port,user:this.config.user,password:this.config.password,database:this.config.database})}async close(){this.connection&&await this.connection.end()}async createTable(e){try{let n=this.groupByTableName(e);for(let[e,a]of Object.entries(n)){let n=this.generateCreateTableSQL(e,a);await this.connection.execute(n)}return!0}catch(e){return console.error("MySQL 테이블 생성 중 오류:",e),!1}}async extractSchema(e){try{let[n]=await this.connection.execute(`
        SELECT 
      ...
      `,[this.config.database,e]);return(Array.isArray(n)?n.map(n=>{let t=Array.isArray(a)?a.find(e=>e.column_name===n.column_name):null;return{...n,table_name:e,foreign_table:t?t.foreign_table:null,foreign_column:t?t.foreign_column:null,is_foreign:!!t}}):[]).map(this.mapColumnToSchema)}catch(e){return console.error("MySQL 스키마 추출 중 오류:",e),[]}}groupByTableName(e){return e.reduce((e,n)=>{let{table_name:a}=n;return e[a]||(e[a]=[]),e[a].push(n),e},{})}generateCreateTableSQL(e,n){let a=n.map(e=>this.generateColumnSQL(e)),t=n.filter(e=>e.is_primary).map(e=>e.column_name),i=n.filter(e=>e.is_foreign&&e.foreign_table&&e.foreign_column).map(e=>this.generateForeignKeySQL(e));return`
      CREATE TABLE ${e} (
        ${a.join(",\n        ")}
        ${t.length>0?`,
        PRIMARY KEY (${t.join(",")})`:""}
